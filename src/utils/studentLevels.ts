...
export const STUDENT_LEVELS: StudentRankLevel[] = [
  {
    ...
    description: 'رتبة الانطلاق في استيعاب ومراجعة أساسيات وقوانين الرياضيات'
  },
  {
    level: 2,
    tier: 'silver',
    ...
    description: 'إتقان حل مسائل الجبر، الدوال الحقيقية، والعمليات الرياضية'
  },
  {
    level: 3,
    tier: 'gold',
    ...
    description: 'تفوق ملحوظ في حساب المثلثات، الهندسة الفراغية، والمتجهات'
  },
  {
    level: 4,
    tier: 'platinum',
    ...
    description: 'مستوى احترافي عالي في التفاضل والتكامل، النهايات، والمصفوفات'
  },
  {
    level: 5,
    tier: 'diamond',
    ...
    description: 'نخبة متميزة تتجاوز أصعب مسائل وتطبيقات الرياضيات بدقة متناهية'
  },
  {
    level: 6,
    tier: 'master',
    ...
    description: 'المرشح الأبرز للمركز الأول على مستوى الجمهورية وتحقيق الدرجة النهائية الكاملة'
  }
];
