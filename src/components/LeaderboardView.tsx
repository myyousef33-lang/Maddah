      ...
      <div className="rounded-3xl border border-blue-100 bg-white p-6 sm:p-8 shadow-xs relative overflow-hidden">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 relative z-10">
          <div className="space-y-2 text-center sm:text-right">
            <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3.5 py-1 text-xs font-black text-[#FDBA74]">
            ...
            <h1 className="text-2xl sm:text-3xl font-black text-[#0D1B3E] dark:text-white">
              أوائل الرياضيات وقائمة المتفوقين
            </h1>
          ...
          <div className="flex items-center gap-4 bg-[#F5F7FA] border border-slate-200 rounded-2xl p-4 shrink-0 shadow-xs">
            ...
            <div>
              ...
              <p className="text-xl font-black text-[#FDBA74]">
                ...
                return (
                  <div
                    ...
                    className={`flex items-center justify-between p-4 sm:p-5 transition-colors ${
                      isCurrent 
                        ? 'bg-blue-50/60 border-r-4 border-[#FDBA74]' 
                        : 'hover:bg-slate-50'
                    }`}
                  >
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-xl font-black text-sm ${
                        rankNum === 1 
                          ? 'bg-[#F97316] text-[#0D1B3E] shadow-xs' 
                          : rankNum === 2 
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          {isCurrent && (
                            <span className="rounded bg-blue-100 text-[#FDBA74] px-1.5 py-0.5 text-[10px] font-bold">
                              أنت
                            </span>
                          )}
                        </div>
                    ...
                    <div className="flex items-center gap-4">
                      <div className="hidden sm:flex items-center gap-1.5">
                        {entry.badges?.slice(0, 2).map((b) => (
                          ...
                          >
                            <Medal className="h-3 w-3 text-[#FDBA74]" />
                            <span>{b.title}</span>
                          </span>
                        ))}
                      </div>
                      ...
                      <div className="text-left">
                        <span className="text-base font-black text-[#FDBA74]">{entry.points}</span>
        ...
        <div className="space-y-6">
            ...
            <div className="rounded-3xl border border-blue-100 bg-white p-6 space-y-5 shadow-xs">
                    ...
                    <div className="space-y-1.5">
                      {q.options.map((opt, optIdx) => {
                        ...
                        if (submittedChallenge) {
                          ...
                          btnStyle = 'border-[#FDBA74] bg-blue-50 text-[#FDBA74] font-bold';
                        }
              ...
              {submittedChallenge ? (
                ...
                <button
                  ...
                  className="w-full rounded-2xl bg-[#F97316] py-2.5 text-xs font-bold text-[#0D1B3E] hover:bg-[#F97316] disabled:opacity-40 transition-colors shadow-xs"
                >
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 space-y-4 shadow-xs">
            ...
            <div className="space-y-2.5 text-xs">
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-[#F5F7FA] p-3">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-blue-50 text-[#FDBA74] border border-blue-200">
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-[#F5F7FA] p-3">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-amber-50 text-[#F97316] border border-amber-200">
