  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 space-y-8 animate-in fade-in duration-300">
      ...
      <div className="text-center space-y-3 max-w-3xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 rounded-full border border-[#F97316]/30 bg-[#0B0B0F] px-4 py-1.5 text-xs font-bold text-[#F97316]">
        ...
        {grades.map(g => (
          <button
            ...
            className={`rounded-xl px-5 py-2.5 text-xs font-bold transition-all ${
              selectedGrade === g.id
                ? 'bg-[#FDBA74] text-white shadow-md shadow-blue-500/20 scale-105'
                : 'border border-slate-200 bg-white text-[#0D1B3E] hover:border-blue-300 hover:text-[#FDBA74]'
            }`}
          >
            {g.label}
          </button>
                ...
                >
                  <div>
                    ...
                    >
                      ...
                      />
                      <div className="absolute top-2.5 right-2.5 rounded-lg bg-white/95 backdrop-blur-md px-2.5 py-1 text-[11px] font-bold text-[#FDBA74] border border-blue-200 shadow-xs z-10">
                        {course.grade}
                      </div>
                    ...
                    <div className="p-5 space-y-3">
                      ...
                      <div className="flex items-center justify-between text-xs text-[#6B7280] pt-2 border-t border-slate-100">
                        ...
                        <span className="text-[#FDBA74] font-black text-sm">{course.price} ج.م</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-5 pt-0 space-y-2">
                    {isEnrolled ? (
                      ...
                      <div className="flex flex-col sm:flex-row items-center gap-2">
                        <button
                          ...
                          className="flex-1 w-full rounded-xl bg-[#F97316] py-2.5 px-3 text-xs font-black text-[#0D1B3E] shadow-sm hover:bg-[#F97316] transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
                        ...
                        <button
                          ...
                          className="flex-1 w-full rounded-xl border-2 border-[#FDBA74] bg-white py-2.5 px-3 text-xs font-bold text-[#FDBA74] hover:bg-blue-50 transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
                        >
                    ...
                    <button
                      onClick={() => onNavigate('course-details', { courseId: course.id })}
                      className="w-full rounded-xl border border-slate-200 bg-[#F5F7FA] py-2 text-[11px] font-bold text-[#6B7280] hover:text-[#FDBA74] hover:border-blue-200 transition-colors"
                    >
