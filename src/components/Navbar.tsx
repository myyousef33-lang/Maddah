...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const primaryNavItems = [
    ...
    { id: 'dashboard', label: 'لوحة دراستي', icon: GraduationCap },
  ...
  const smartToolsItems = [
    { id: 'physics-lab', label: 'المعمل الرياضي التفاعلي', desc: 'محاكاة رياضية وهندسية ورسوم بيانية تفاعلية', icon: Sparkles, color: 'text-cyan-400', bg: 'bg-cyan-500/15' },
    { id: 'flashcards', label: 'بطاقات المراجعة والقوانين', desc: 'مراجعة وحفظ المفاهيم والقوانين الرياضية بسرعة', icon: Layers, color: 'text-amber-400', bg: 'bg-amber-500/15' },
    { id: 'ai-assistant', label: 'المساعد الذكي (مداح AI)', desc: 'إجابة فورية وحل مسائل وخطوات الرياضيات بالذكاء الاصطناعي', icon: Bot, color: 'text-emerald-400', bg: 'bg-emerald-500/15' },
  ...
  const allMobileNavItems = [
    ...
    { id: 'pdf-library', label: 'المذكرات والملازم', icon: FileText },
    { id: 'physics-lab', label: 'المعمل الرياضي التفاعلي', icon: Sparkles },
