        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-3">
            ...
            <h1 className="text-2xl sm:text-3xl font-black text-[#0D1B3E]">
              تقرير الكفاءة وتشخيص الأخطاء في مادة الرياضيات
            </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {activeWeaknesses.length === 0 ? (
            <div className="rounded-3xl border border-slate-200 bg-white p-12 text-center space-y-4 shadow-xs">
              ...
              <button
                ...
                className="rounded-xl bg-[#F97316] px-6 py-2.5 text-xs font-bold text-[#0D1B3E] hover:bg-[#F97316] transition-colors shadow-xs"
              >
                  ...
                  <div className="rounded-2xl border border-purple-100 bg-purple-50/50 p-4 space-y-3">
                    ...
                    {wp.suggestedLessonTitle && (
                      <div className="pt-2 flex items-center justify-between border-t border-purple-200">
                        ...
                        <button
                          onClick={() => onNavigate('courses-catalog')}
                          className="flex items-center gap-1 rounded-lg bg-[#F97316] px-3 py-1 text-[11px] font-bold text-[#0D1B3E] hover:bg-[#F97316] transition-colors"
                        >
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-3xl border border-purple-100 bg-white p-6 space-y-4 shadow-xs">
            ...
            >
              فتح المساعد الذكي لمداح الرياضيات
            </button>
          </div>

          {/* Golden Rules for Mathematics Exam */}
          <div className="rounded-3xl border border-slate-200 bg-white p-6 space-y-4 shadow-xs">
            <h3 className="text-sm font-black text-[#0D1B3E] flex items-center gap-2">
              ...
              <span>نصائح ذهبية لمعالجة أخطاء الرياضيات</span>
            </h3>
            <ul className="text-xs text-[#6B7280] space-y-3 leading-relaxed">
              <li className="flex items-start gap-2">
                <span className="text-[#F97316] font-bold">•</span>
                <span><b className="text-[#0D1B3E]">الخطوات الرياضية:</b> اكتب خطوات الحل بتسلسل منطقي ولا تختصر الخطوات لتفادي أخطاء الإشارات والحسابات.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#F97316] font-bold">•</span>
                <span><b className="text-[#0D1B3E]">مجال الدوال والقيم الحرجة:</b> تأكد دائماً من تحديد مجال الدالة واستبعاد القيم غير المعرفة قبل دراسة التزايد والتناقص.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#F97316] font-bold">•</span>
                <span><b className="text-[#0D1B3E]">المتطابقات والقواعد الأساسية:</b> راجع المتطابقات المثلثية وقوانين التكامل الأساسية باستمرار وافهم اشتقاقها بدلاً من الحفظ المجرد.</span>
              </li>
            </ul>
          </div>
        </div>
