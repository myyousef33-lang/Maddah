    ...
    <footer className="mt-20 border-t border-slate-200 dark:border-slate-800/80 bg-white dark:bg-[#0B0B0F] text-[#6B7280] dark:text-slate-400 transition-colors">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div className="space-y-4 md:col-span-2">
            ...
            <p className="text-sm leading-relaxed text-[#6B7280] dark:text-slate-300">
              المنصة المتخصصة الأولى في شرح وتأسيس وتبسيط مادة الرياضيات لطلاب جميع المراحل الدراسية والشهادات العامة. 
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <span className="flex items-center gap-1.5 rounded-xl border border-[#F97316]/30 bg-[#0B0B0F] px-3 py-1.5 text-xs text-[#F97316] font-medium">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <button
                  ...
                  className="text-[#6B7280] dark:text-slate-400 hover:text-[#F97316] dark:hover:text-[#F97316] transition-colors cursor-pointer text-right"
                >
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2.5 rounded-xl border border-blue-200 dark:border-blue-800/60 bg-blue-50 dark:bg-blue-950/40 px-3.5 py-2.5 text-xs font-bold text-[#FDBA74] dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors"
              >
                <Send className="h-4 w-4 text-[#FDBA74] dark:text-blue-400" />
        ...
        <div className="mt-10 border-t border-slate-200 dark:border-slate-800 pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-[#6B7280] dark:text-slate-400">
          ...
          <div className="inline-flex items-center gap-2.5 rounded-full border border-blue-200 dark:border-slate-800 bg-white dark:bg-[#12121A] px-4 py-2 shadow-sm hover:border-[#FDBA74] transition-all duration-300 group cursor-default" dir="ltr">
            ...
            <Code2 className="h-4 w-4 text-[#FDBA74] group-hover:rotate-12 transition-transform duration-300" />
            <span className="text-xs text-[#6B7280] dark:text-slate-400 font-sans tracking-wide">
              Designed & Engineered by <span className="font-bold text-[#FDBA74] dark:text-blue-400 group-hover:text-blue-700 dark:group-hover:text-blue-300 transition-colors tracking-wider">Yousef Emad</span>
            </span>
          </div>

          <div className="flex items-center gap-2 text-[#0D1B3E] dark:text-slate-200 font-medium">
            <Sparkles className="h-3.5 w-3.5 text-[#F97316]" />
            <span>نحو الدرجة النهائية في الرياضيات</span>
          </div>
        </div>
      </div>
    </footer>
