...
export const AdminReportsExportTab: React.FC = () => {
  ...
  const exportStudents = () => {
    ...
    downloadCSV(`تقرير_الطلاب_منصة_مداح_الرياضيات_${new Date().toISOString().slice(0, 10)}.csv`, csv);
    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-slate-200 pb-5">
        <h2 className="text-xl font-black text-[#0D1B3E] flex items-center gap-2">
          <FileSpreadsheet className="h-6 w-6 text-[#FDBA74]" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        {/* Export Students */}
        <div className="rounded-2xl border border-slate-200 bg-white p-6 space-y-4 flex flex-col justify-between hover:border-[#FDBA74]/40 shadow-xs transition-colors">
          <div className="space-y-2">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-50 border border-blue-200 text-[#FDBA74]">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 rounded-xl bg-[#FDBA74] hover:bg-blue-700 text-white py-3 text-xs font-black transition-all shadow-xs disabled:opacity-50"
          >
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 space-y-4 flex flex-col justify-between hover:border-[#FDBA74]/40 shadow-xs transition-colors">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 rounded-xl bg-[#F97316] hover:bg-[#F97316] text-[#0D1B3E] py-3 text-xs font-black transition-all shadow-xs disabled:opacity-50"
          >
            <Download className="h-4 w-4" />
