...
const HomeCourseCard: React.FC<HomeCourseCardProps> = React.memo(({
  ...
  return (
    <div
      className={`glass-card glass-card-hover rounded-3xl overflow-hidden flex flex-col justify-between group border border-[#C7D9FE] hover:border-[#00B4FF] transition-all shadow-xs h-full ${
    ...
    >
      <div>
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/30 backdrop-blur-[2px] pointer-events-none">
            <div className="h-13 w-13 rounded-full bg-[#D4AF37] text-[#0D1B3E] flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform">
          ...
          <div className="absolute top-3 right-3 z-10">
            <span className="rounded-xl bg-white/95 backdrop-blur-md px-3 py-1 text-xs font-bold text-[#00B4FF] border border-blue-200 shadow-sm">
              {course.grade}
            </span>
          </div>
          ...
          {/* Price Badge */}
          <div className="absolute bottom-3 left-3 rounded-xl bg-[#D4AF37] px-3 py-1 text-xs font-bold text-[#0D1B3E] shadow-sm z-10">
          ...
          <div className="absolute bottom-3 right-3 flex items-center gap-1.5 rounded-lg bg-black/75 backdrop-blur-md px-2.5 py-1 text-xs font-bold text-white z-10">
            <PlayCircle className="h-3.5 w-3.5 text-[#D4AF37]" />
        ...
        <div className="p-5 lg:p-6 space-y-2.5">
          <div className="flex items-center gap-2">
            <div className="h-6 w-6 rounded-full bg-blue-50 flex items-center justify-center text-[#00B4FF] text-[10px] font-black border border-blue-200 shrink-0">
              أكـ
            </div>
          ...
          <h3 className="font-bold text-[#0D1B3E] text-base leading-snug line-clamp-2 min-h-[2.75rem] group-hover:text-[#00B4FF] transition-colors">
            {course.title}
          </h3>
      ...
      <div className="p-5 lg:p-6 pt-0">
        <button
          ...
          className="w-full rounded-2xl bg-[#00B4FF] hover:bg-blue-700 py-3 text-xs sm:text-sm font-bold text-white transition-all shadow-sm shadow-blue-500/20 flex items-center justify-center gap-2 cursor-pointer"
        >
        ...
        <div className="rounded-3xl border border-[#C7D9FE] bg-[#EBF1FE] p-5 sm:p-8 lg:p-10 shadow-sm space-y-6">
          <div className="flex items-center justify-between border-b border-[#C7D9FE]/80 pb-4">
            <div className="flex items-center gap-3">
              <div className="p-2.5 rounded-2xl bg-[#D4AF37]/20 text-[#0D1B3E] border border-[#D4AF37]/40">
                <PlayCircle className="h-6 w-6 text-[#00B4FF]" />
              </div>
              <div>
            ...
            <span className="hidden sm:inline-flex text-xs font-bold text-[#00B4FF] bg-white px-4 py-1.5 rounded-full border border-[#B4CFFE] shadow-xs">
              فيديو توضيحي رسمي
            </span>
          </div>
    ...
    <div className="space-y-16 lg:space-y-24 animate-in fade-in duration-300 max-w-full pb-16 bg-[#F5F7FA] dark:bg-[#080D21] text-[#0D1B3E] dark:text-slate-100 transition-colors">
      ...
      <section className="relative overflow-hidden pt-4 pb-8 sm:pt-6 sm:pb-12 lg:pt-8 lg:pb-14">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-6 sm:space-y-8">
          ...
          {/* 1. Teacher Photo with Luxury Gold & Obsidian Semi-Circle Backdrop */}
          <div className="relative mx-auto w-full max-w-[320px] sm:max-w-[360px] md:max-w-[400px] flex flex-col items-center select-none">
            
            {/* The Luxury Obsidian & Gold Arch / Half-Circle Backdrop */}
            <div className="relative w-full h-[320px] sm:h-[370px] md:h-[410px] flex items-end justify-center">
              
              {/* Outer Decorative Ring */}
              <div className="absolute top-2 w-[270px] h-[270px] sm:w-[320px] sm:h-[320px] md:w-[350px] md:h-[350px] rounded-full border-2 border-[#D4AF37]/40 pointer-events-none animate-[spin_30s_linear_infinite]" />
              
              {/* The Solid Obsidian & Gold Gradient Arch behind the teacher's upper body */}
              ...
              <div className="absolute -bottom-3 z-30 inline-flex items-center gap-2 rounded-full bg-[#0B0B0F] border-2 border-[#D4AF37] px-4 py-1.5 text-xs sm:text-sm font-bold text-[#D4AF37] shadow-lg">
          ...
          <div className="space-y-4 max-w-3xl mx-auto pt-2">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/30 text-[#B8860B] dark:text-[#D4AF37] text-xs font-bold shadow-xs">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-[#6B7280] dark:text-slate-300 leading-relaxed max-w-2xl mx-auto font-normal">
          ...
          {/* 4. Action Buttons (Luxury Gold + Obsidian + Electric Cyan) */}
          ...
          <div className="pt-4 max-w-3xl mx-auto space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              <div className="inline-flex items-center gap-2 rounded-full border border-[#D4AF37]/40 bg-[#0B0B0F] px-4 py-1.5 text-xs font-bold text-white shadow-sm">
                ...
                <span>
                  {activeCount >= 3 ? (
                    <>
                      <strong className="text-[#D4AF37] font-black mx-1 font-mono">{activeCount.toLocaleString('ar-EG')}</strong>{' '}
                      طالب بيذاكر دلوقتي
                    </>
                  ) : (
              ...
              <div className="inline-flex items-center gap-2 rounded-full border border-[#00F0FF]/40 bg-[#0B0B0F] px-4 py-1.5 text-xs font-bold text-white shadow-sm">
            ...
            {/* Quick Stats Grid */}
            <div className="grid grid-cols-3 gap-3 sm:gap-6 p-4 sm:p-6 rounded-3xl bg-[#0B0B0F] border border-[#D4AF37]/30 shadow-xl text-center text-white">
              <div>
                <p className="text-xl sm:text-3xl font-black text-[#D4AF37] font-mono">+15,000</p>
                <p className="text-xs sm:text-sm text-slate-300 font-medium mt-0.5">طالب مستفيد</p>
              </div>
              <div className="border-x border-slate-700/50">
                <p className="text-xl sm:text-3xl font-black text-[#D4AF37] font-mono">100%</p>
                <p className="text-xs sm:text-sm text-slate-300 font-medium mt-0.5">تغطية أفكار الامتحانات</p>
              </div>
              <div>
                <p className="text-xl sm:text-3xl font-black text-[#00F0FF] font-mono">24/7</p>
                <p className="text-xs sm:text-sm text-slate-300 font-medium mt-0.5">دعم ومتابعة مستمرة</p>
              </div>
            </div>

            {/* Security & Speed Trust Badge */}
            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-[#0B0B0F] border border-[#D4AF37]/30 text-xs text-slate-200 font-medium shadow-sm">
      ...
      <section className="mx-auto max-w-7xl 2xl:max-w-screen-2xl px-4 sm:px-6 lg:px-10 xl:px-12">
        <div className="text-center space-y-3 max-w-3xl mx-auto mb-10 lg:mb-14">
          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-[#0D1B3E] dark:text-white">لماذا منصة <span className="text-[#D4AF37] dark:text-[#D4AF37] font-calligraphy">مداح الرياضيات</span>؟</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          <ScrollReveal index={0} className="h-full">
            <div className="glass-card rounded-3xl p-6 sm:p-8 space-y-4 hover:border-[#D4AF37] hover:scale-[1.02] transition-all h-full">
              <div className="rounded-2xl bg-white dark:bg-[#0B0B0F] border border-[#D4AF37]/40 p-4 w-fit text-[#D4AF37] shadow-xs">
          ...
          <ScrollReveal index={1} className="h-full">
            <div className="glass-card rounded-3xl p-6 sm:p-8 space-y-4 hover:border-[#00B4FF] hover:scale-[1.02] transition-all h-full">
              <div className="rounded-2xl bg-[#D4AF37]/25 border border-[#D4AF37]/50 p-4 w-fit text-[#0D1B3E] shadow-xs">
                <Award className="h-7 w-7 text-[#00B4FF]" />
              </div>
          ...
          <ScrollReveal index={2} className="h-full">
            <div className="glass-card rounded-3xl p-6 sm:p-8 space-y-4 hover:border-[#00B4FF] hover:scale-[1.02] transition-all h-full">
              <div className="rounded-2xl bg-white border border-[#B4CFFE] p-4 w-fit text-[#00B4FF] shadow-xs">
          ...
          <ScrollReveal index={3} className="h-full">
            <div className="glass-card rounded-3xl p-6 sm:p-8 space-y-4 hover:border-[#00B4FF] hover:scale-[1.02] transition-all h-full">
              <div className="rounded-2xl bg-[#D4AF37]/25 border border-[#D4AF37]/50 p-4 w-fit text-[#0D1B3E] shadow-xs">
                <ShieldCheck className="h-7 w-7 text-[#00B4FF]" />
              </div>
      ...
      <section className="mx-auto max-w-7xl 2xl:max-w-screen-2xl px-4 sm:px-6 lg:px-10 xl:px-12 space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-6">
          <div>
            <div className="flex items-center gap-3">
              <span className="h-3 w-3 rounded-full bg-[#D4AF37] animate-pulse"></span>
          ...
          <div className="flex items-center gap-3 self-end sm:self-auto">
            ...
            {courses.length > 0 && courseDisplayMode === 'carousel' && (
              <div className="flex items-center gap-1.5 bg-white p-1.5 rounded-2xl border border-slate-200 shadow-xs">
                <button
                  ...
                  className="p-2.5 rounded-xl bg-slate-50 text-[#6B7280] hover:text-[#00B4FF] hover:bg-blue-50 transition-all"
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs sm:text-sm font-bold text-[#00B4FF] hover:underline bg-blue-50 px-4 py-2.5 rounded-2xl border border-blue-200"
            >
        ...
        {courses.length === 0 ? (
          <div className="rounded-3xl border border-[#C7D9FE] bg-[#EBF1FE] p-12 text-center max-w-xl mx-auto space-y-4 shadow-sm">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-white border border-[#B4CFFE] text-[#00B4FF] shadow-xs">
        ...
        <ScrollReveal index={0} className="w-full">
          <div className="rounded-3xl border border-[#C7D9FE] bg-[#EBF1FE] p-8 sm:p-12 lg:p-16 flex flex-col lg:flex-row items-center justify-between gap-8 shadow-xs">
            <div className="space-y-3 text-center lg:text-right">
              <span className="rounded-full bg-white border border-[#B4CFFE] px-4 py-1.5 text-xs font-bold text-[#00B4FF] shadow-xs">
                المكتبة والملازم
              </span>
            ...
            <button
              ...
              className="rounded-2xl bg-[#D4AF37] px-9 py-4 text-sm sm:text-base font-bold text-[#0D1B3E] shadow-md shadow-[#D4AF37]/25 hover:bg-[#D4AF37] hover:scale-105 transition-all shrink-0 cursor-pointer"
            >
              تصفح مكتبة الـ PDF
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          <ScrollReveal index={0} className="h-full">
            <div className="glass-card rounded-3xl p-6 sm:p-8 space-y-4 shadow-xs h-full">
              <div className="flex items-center gap-1 text-[#D4AF37]">
                {[...Array(5)].map((_, i) => <Star key={i} className="h-4 w-4 fill-[#D4AF37]" />)}
              </div>
              ...
              <div className="pt-3 border-t border-[#D4AF37]/30 text-xs sm:text-sm font-bold text-[#D4AF37]">
          ...
          <ScrollReveal index={2} className="h-full">
            <div className="glass-card rounded-3xl p-6 sm:p-8 space-y-4 shadow-xs h-full">
              ...
              <div className="pt-3 border-t border-[#C7D9FE]/80 text-xs sm:text-sm font-bold text-[#00B4FF]">
