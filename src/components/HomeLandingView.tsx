    ...
    <div className="space-y-16 lg:space-y-24 animate-in fade-in duration-300 overflow-x-hidden max-w-full pb-16 bg-[#F5F7FA] dark:bg-[#080D21] text-[#0D1B3E] dark:text-slate-100 transition-colors">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-6 sm:space-y-8">
          ...
          <div className="relative mx-auto w-full max-w-[320px] sm:max-w-[360px] md:max-w-[400px] flex flex-col items-center select-none">
            ...
            <div className="relative w-full h-[320px] sm:h-[370px] md:h-[410px] flex items-end justify-center">
              ...
              <div className="absolute top-4 w-[250px] h-[250px] sm:w-[290px] sm:h-[290px] md:w-[320px] md:h-[320px] rounded-full bg-gradient-to-b from-[#06090F] via-[#0D1527] to-[#162238] border border-[#D4AF37]/50 shadow-xl shadow-[#D4AF37]/15 flex items-center justify-center overflow-hidden">
              ...
              <div className="absolute -left-2 sm:-left-4 top-1/3 z-20 bg-[#06090F]/95 backdrop-blur-md border border-[#D4AF37]/60 px-3 py-1 rounded-2xl shadow-md">
                <span className="text-xs sm:text-sm font-black font-mono text-[#F3C644] tracking-wide dir-ltr inline-block">
                  f(x) = ∫ e^x
                </span>
              </div>

              {/* Floating Math Equation Badge on Right: e^(iπ) + 1 = 0 */}
              <div className="absolute -right-2 sm:-right-4 top-1/3 z-20 bg-[#06090F]/95 backdrop-blur-md border border-[#00F0FF]/50 px-3 py-1 rounded-2xl shadow-md">
              ...
              <div className="absolute -bottom-3 z-30 inline-flex items-center gap-2 rounded-full bg-[#06090F] border-2 border-[#D4AF37] px-4 py-1.5 text-xs sm:text-sm font-bold text-[#F3C644] shadow-lg">
          ...
          <div className="space-y-4 max-w-3xl mx-auto pt-2">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/30 text-[#B8860B] dark:text-[#F3C644] text-xs font-bold shadow-xs">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-[#0D1B3E] dark:text-white leading-[1.2] tracking-tight">
              <span className="block font-calligraphy text-4xl sm:text-6xl lg:text-7xl text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] via-[#F3C644] to-[#B8860B] gold-glow-text py-1">
                مداح الرياضيات
              </span>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3.5 pt-2">
            {student ? (
              <button
                ...
                className="inline-flex items-center justify-center gap-2.5 rounded-2xl bg-gradient-to-r from-[#D4AF37] via-[#F3C644] to-[#E5B83B] px-8 py-3.5 sm:px-9 sm:py-4 text-sm sm:text-base font-black text-[#06090F] shadow-lg shadow-[#D4AF37]/25 hover:brightness-105 hover:scale-[1.02] active:scale-[0.98] transition-all"
              >
                <GraduationCap className="h-5 w-5 text-[#06090F]" />
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2.5 rounded-2xl bg-gradient-to-r from-[#D4AF37] via-[#F3C644] to-[#E5B83B] px-8 py-3.5 sm:px-9 sm:py-4 text-sm sm:text-base font-black text-[#06090F] shadow-lg shadow-[#D4AF37]/25 hover:brightness-105 hover:scale-[1.02] active:scale-[0.98] transition-all"
              >
                <Sparkles className="h-5 w-5 text-[#06090F]" />
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2.5 rounded-2xl border-2 border-[#D4AF37] bg-[#06090F] px-7 py-3.5 sm:px-8 sm:py-4 text-sm sm:text-base font-bold text-[#F3C644] hover:bg-[#0E1526] hover:border-[#00F0FF] hover:text-[#00F0FF] hover:scale-[1.02] active:scale-[0.98] transition-all shadow-md"
            >
              <Key className="h-5 w-5 text-[#F3C644]" />
          ...
          <div className="pt-4 max-w-3xl mx-auto space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              <div className="inline-flex items-center gap-2 rounded-full border border-[#D4AF37]/40 bg-[#06090F] px-4 py-1.5 text-xs font-bold text-white shadow-sm">
                ...
                <span>
                  {activeCount >= 3 ? (
                    <>
                      <strong className="text-[#F3C644] font-black mx-1 font-mono">{activeCount.toLocaleString('ar-EG')}</strong>{' '}
                      طالب بيذاكر دلوقتي
                    </>
                  ) : (
              ...
              <div className="inline-flex items-center gap-2 rounded-full border border-[#00F0FF]/40 bg-[#06090F] px-4 py-1.5 text-xs font-bold text-white shadow-sm">
            ...
            {/* Quick Stats Grid */}
            <div className="grid grid-cols-3 gap-3 sm:gap-6 p-4 sm:p-6 rounded-3xl bg-[#06090F] border border-[#D4AF37]/30 shadow-xl text-center text-white">
              <div>
                <p className="text-xl sm:text-3xl font-black text-[#F3C644] font-mono">+15,000</p>
                <p className="text-xs sm:text-sm text-slate-300 font-medium mt-0.5">طالب مستفيد</p>
              </div>
              <div className="border-x border-slate-700/50">
                <p className="text-xl sm:text-3xl font-black text-[#F3C644] font-mono">100%</p>
            ...
            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-[#06090F] border border-[#D4AF37]/30 text-xs text-slate-200 font-medium shadow-sm">
              <ShieldCheck className="h-4 w-4 text-[#F3C644] shrink-0" />
      ...
      <section className="mx-auto max-w-7xl 2xl:max-w-screen-2xl px-4 sm:px-6 lg:px-10 xl:px-12">
        <div className="text-center space-y-3 max-w-3xl mx-auto mb-10 lg:mb-14">
          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-[#0D1B3E] dark:text-white">لماذا منصة <span className="text-[#D4AF37] dark:text-[#F3C644] font-calligraphy">مداح الرياضيات</span>؟</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          <ScrollReveal index={0} className="h-full">
            <div className="glass-card rounded-3xl p-6 sm:p-8 space-y-4 hover:border-[#D4AF37] hover:scale-[1.02] transition-all h-full">
              <div className="rounded-2xl bg-white dark:bg-[#06090F] border border-[#D4AF37]/40 p-4 w-fit text-[#D4AF37] shadow-xs">
